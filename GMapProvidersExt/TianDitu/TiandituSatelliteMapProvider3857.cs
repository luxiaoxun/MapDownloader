...
{
    public class TiandituSatelliteMapProvider3857 : TiandituProviderBase3857
    {
        // Fields
        private string cnName;
        private Guid id = new Guid("B8A31747-2D7E-4EE3-9E71-4A314F26E6CC");
        public static readonly TiandituSatelliteMapProvider3857 Instance;
        private string name;

        // Methods
        static TiandituSatelliteMapProvider3857()
        {
            Instance = new TiandituSatelliteMapProvider3857();
        }

        public TiandituSatelliteMapProvider3857()
        {
