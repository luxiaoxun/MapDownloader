...
namespace GMapProvidersExt
{
    public static class CoordinateTransformUtil
    {
        ...
        public static Point2D Tranform(this Point2D point, CoordinateTransformation transformObj = null)
        {
        ...
        public static Point2D Tranform(this Point2D point, string sourceProjection, string targetProjection)
        {
            Point2D pointd;
        ...
        {
            return new Point2D(latLng.Lng, latLng.Lat).Tranform(ProjectionUtil.GetWKTFromEpsgCode(0x10e6), targetProjection);
        }
        ...
        public static List<PointLatLng> TransformToWGS84(this List<PointLatLng> points, string sourceProjection)
        {
            ...
            {
                Point2D pointd2 = new Point2D(lng.Lng, lng.Lat).Tranform(sourceProjection, ProjectionUtil.GetWKTFromEpsgCode(0x10e6));
        ...
        {
            Point2D pointd = point.Tranform(sourceProjection, ProjectionUtil.GetWKTFromEpsgCode(0x10e6));
