...
namespace GMapTools
{
    public class DrawDistanceMarkerToolTip : GMapToolTip
    {
        public float Radius = 6f;

        public DrawDistanceMarkerToolTip(GMapMarker marker)
            : base(marker)
        {
        ...
        public override void OnRender(Graphics g)
        {
            ...
            rect.Offset(Offset.X-10, Offset.Y+30);

            g.DrawLine(Stroke, Marker.ToolTipPosition.X, Marker.ToolTipPosition.Y, rect.X + Radius/2,
