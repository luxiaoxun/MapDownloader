...
namespace GMap.NET.MapProviders
{
   ...
   public class GMapProviders
   {
      ...
      public static readonly OpenStreetMapQuestSateliteProvider OpenStreetMapQuestSatelite = OpenStreetMapQuestSateliteProvider.Instance;//#133  correct spelling 'Sattelite' to 'Satellite' throughout
